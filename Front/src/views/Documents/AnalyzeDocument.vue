<template>
  <div class="container">
    <div class="analyze-box">
      ...
      <!-- Options d'analyse (cosmétiques) -->
      <div v-if="selectedDocument" class="analysis-options">
        <div class="options-grid">
          <!-- Solutions de Reconnaissance -->
          <div class="option-section">
            <h3>Solutions de Reconnaissance</h3>
            <div class="radio-group">
              <label class="radio-item active-option">
                <input type="radio" checked disabled>
                <span>LLAVA</span>
                <span class="active-badge">Actif</span>
              </label>
              <label class="radio-item disabled-option">
                <input type="radio" disabled>
                <span>DeepSeek</span>
                <span class="coming-soon">Prochainement</span>
              </label>
            </div>
          </div>
        ...
        <div class="analysis-info">
          ...
          <p>L'analyse utilise actuellement uniquement LLaVA avec description détaillée en français.</p>
        </div>
      </div>
...
const startAnalysis = async () => {
  ...
  try {
    const response = await axios.post(
      ...
      {}, // Corps vide car votre backend ne semble pas attendre de données
      {
        headers: {
    ...
    analysisResults.value = {
      ...
      analysisModel: response.data.analysisModel || "LLaVA",
